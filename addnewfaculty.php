	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					<label for="Father Name">Last Name :<span style="color: #ff0000;">*</span></label>
				...
				<div class="form-group">
					<input type="submit" value="Add New Faculty" name="addnewfaculty" style="border-radius:0%"
			...
			if (isset($_POST['addnewfaculty'])) {
				...
				$temppass = $_POST['pass'];
				// adding new faculty
				$sql = "INSERT INTO facutlytable (FName, FaName, Addrs, Gender, JDate, City, Pass, PhNo) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
				$stmt = $pdo->prepare($sql);
				$stmt->execute([$tempfname, $tempfaname, $tempaddrs, $tempgender, $tempjdate, $tempcity, $temppass, $tempphno]);
				...
				if ($stmt->rowCount() > 0) {
                    ...
                    <strong>Success!</strong> New Faculty Added. Faculty ID is : <strong>" . $pdo->lastInsertId() . "</strong></div>";

				} else {
					//error message if SQL query Fails
					echo "<br><Strong>New Faculty Adding Failure. Try Again</strong>";
				}
